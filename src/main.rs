...
fn create_router() -> Router {
    ...
    Router::new()
        ...
        .nest("/profile", Router::new()
            ...
            .route("/api/public-notes", get(profile::handlers::get_public_notes_api))
            .route("/api/public-notes", post(profile::handlers::save_public_notes_api))
            .route("/api/channel-setting", get(profile::handlers::get_user_channel_setting_api))
            .route("/api/channel-setting", post(profile::handlers::save_user_channel_setting_api))
